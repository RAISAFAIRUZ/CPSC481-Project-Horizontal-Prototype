document.addEventListener("DOMContentLoaded", function () {
  ...
  function showOrderConfirmationPage() {
    console.log("showOrderConfirmationPage() called");
  ...
  const PRODUCTS = [
    {
      ...
      tags: ["Banff", "Mountain", "Rainbow", "Sky", "Night"],
    },
    {
      id: "2",
      name: "Cloudy Island",
      price: 3.99,
      imageUrl:
        "https://w8olmmxvkm.ufs.sh/f/O1k8BV0YGt7LXFIRZLD1eUgWtTMDAXrbSHY7pKkVBwIoi4RQ",
      category: "hawaii",
    ...
    const categories = [
      {
        name: "Bestsellers",
        category: "bestsellers",
        imageUrl: "/images/BeachSunset.jpg",
      },
      {
        name: "Hawaii",
        category: "hawaii",
        imageUrl: "/images/HawaiiOverview.jpg",
      },
      {
        name: "Banff",
        category: "banff",
        imageUrl: "/images/BanffMountains.jpg",
      },
      {
        name: "Mexico",
        category: "mexico",
        imageUrl: "/images/MexicoStone.jpg",
      },
    ];
      ...
      <div class="shop-all-container" style="display: flex; align-items: center; width: 100%;">
        ...
        <div class="shop-all-gallery" style="flex: 2; display: flex;">
          <div class="gallery-row" style="margin-right: 10px;">
            <div class="gallery-image"><img src="/images/HawaiiRainbow.jpg" alt="Gallery 1"></div>
            <div style="margin-top: 10px;" class="gallery-image"><img src="/images/PinkSunset.jpg" alt="Gallery 2"></div>
          </div>
          <div class="gallery-row">
            <div class="gallery-image"><img src="/images/BeachSunset.jpg" alt="Gallery 3"></div>
            <div style="margin-top: 10px;" class="gallery-image"><img src="/images/BanffNight.jpg" alt="Gallery 4"></div>
          </div>
        </div>
      </div>
    `;
  ...
  function initProductDetailPage(productId) {
    ...
    const relatedProducts = PRODUCTS.filter((p) => p.id !== product.id).slice(0, 3,); //max 3
  ...
  function updateCartTotal() {
    console.log("updateCartTotal() called"); // Add this line
    let cartItems = JSON.parse(localStorage.getItem(STORAGE_KEYS.CART_ITEMS)) || [];
    console.log("cartItems:", cartItems); // Add this line
    const total = cartItems.reduce((acc, item) => acc + item.price * (item.quantity || 1), 0);
    console.log("Total:", total); // Add this line
  ...
  function initPaymentPage() {
    // Use setTimeout to ensure DOM is fully rendered before updating the total
    setTimeout(() => {
      updateCartTotal();
    }, 100);
  ...
  function processPayment() {
    // Store cart items temporarily for the order confirmation page
  ...
  function initOrderConfirmationPage() {
    ...
    if (product) {
      ...
      document.getElementById("download-button").addEventListener("click", () => {
        ...
        window.location.href = product.imageUrl; // Replace with the actual URL
      });
